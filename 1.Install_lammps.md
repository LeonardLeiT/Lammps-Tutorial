...
![alt text](Fig/1/1.7.png)

LAMMPS的lib/hdnnp目录为：

![alt text](Fig/1/1.8.png)

##### 3. 安装编译

需要注释掉`Install.py`文件中的下载指令，在90行左右：

![alt text](Fig/1/1.9.png)
...
![alt text](Fig/1/1.12.png)

编译成功！！

![alt text](Fig/1/1.13.png)