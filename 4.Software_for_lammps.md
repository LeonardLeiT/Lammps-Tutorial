...
![alt text](Fig/4/4.6.png)

可以看到，文件夹中生成了一个名为`aluminium.xsf`的文件，

用`ovito` 直接打开

![alt text](Fig/4/4.7.png)
